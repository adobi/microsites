    ...
    <?php echo form_open_multipart('', array('id'=>'edit-review-form')) ?>
        <div class="pill-content">
            ...
            <div class="clearfix separator">
             ...
             -->     
            <div id="review" class="active section-content">
                <div class="clearfix">
                ...
                <div class="clearfix">
                    ...
                    <div class="input">
                        <textarea rows="5" name="description" id="redactor" class="xxlarge" style="width: 100%; height: 320px;"><?php echo $item ? $item->description : '' ?></textarea>
                    </div>
                </div>
                <div class="clearfix">
